...
const u32 wiz6100_map[NUM_REGS] = { // W6100 operation verified
    ...
    [REG_S0_REGS     ]      = 0x080000,   /* Socket 0 register base
    [REG_S0_REGS_LEN ]      = 0x0100,   /* Socket register length
    
    [REG_Sn_MR       ]      = 0x0000,   /* Socket n Mode Register (relative) */
        [REG_S0_MR_MACRAW]  = 0x07,     /* MAC RAW mode
        [REG_S0_MR_MF    ]  = 0x40,     /* MAC Filter */
    
    [REG_Sn_CR       ]      = 0x0010,   /* Socket n Command Register
        [REG_S0_CR_OPEN  ]  = 0x01,     /* OPEN command */
        [REG_S0_CR_CLOSE ]  = 0x10,     /* CLOSE command */
        [REG_S0_CR_SEND  ]  = 0x20,     /* SEND command */
        [REG_S0_CR_RECV  ]  = 0x40,     /* RECV command */
    
    [REG_Sn_IR       ]      = 0x0020,   /* Socket n Interrupt Register 
    [REG_set_Sn_IR   ]      = 0x0028,   /* Socket n Interrupt Clear Register
        [REG_S0_IR_SENDOK]  = 0x10,     /* SEND_OK interrupt */
        [REG_S0_IR_RECV  ]  = 0x04,     /* RECV interrupt */
    
    [REG_Sn_SR       ]      = 0x0030,   /* Socket n Status Register 
        [REG_S0_SR_MACRAW]  = 0x42,     /* MACRAW status */

    [REG_Sn_TX_FSR   ]      = 0x0204,   /* Socket n TX Free Size */
    [REG_Sn_TX_RD    ]      = 0x0208,   /* Socket n TX Read Pointer */
    [REG_Sn_TX_WR    ]      = 0x020c,   /* Socket n TX Write Pointer */
    [REG_Sn_RX_RSR   ]      = 0x0224,   /* Socket n RX Received Size */
    [REG_Sn_RX_RD    ]      = 0x0228,   /* Socket n RX Read Pointer */
    ...
    /* Memory Map - TODO: Need to verify complete W6100 memory map */
    [REG_TX_MEM_START]      = 0x100000,  
    [REG_TX_MEM_SIZE ]      = 0x4000, 
    [REG_RX_MEM_START]      = 0x180000,  
    [REG_RX_MEM_SIZE ]      = 0x4000,   
};

const u32 wiz6300_map[NUM_REGS] = {
    /* TODO: Need to verify complete W6300 datasheet - Expected to be similar to W6100 */
    /* Common Registers */
    [REG_COMMON_BASE ]      = 0x0000,   /* TODO: Needs verification */
    [REG_COMMON_REGS ]      = 0x0000,   /* TODO: Needs verification */
    [REG_COMMON_REGS_LEN]   = 0x0100,   /* TODO: Needs verification */
    
    [REG_MR          ]      = 0x0000,   /* Mode Register - TODO: Needs verification */
        [REG_MR_RST  ]      = 0x80,     /* S/W reset */
        [REG_MR_PB   ]      = 0x10,     /* Ping block */
        [REG_MR_AI   ]      = 0x02,     /* Address Auto-Increment */
        [REG_MR_IND  ]      = 0x01,     /* Indirect mode */

    [REG_SHAR        ]      = 0x4120,   /* Source MAC address - TODO: Needs verification */
    [REG_IR          ]      = 0x2100,   /* Interrupt Register - TODO: Needs verification */
        [REG_IR_S0   ]      = 0x01,     /* Socket 0 interrupt bit */
    
    [REG_IMR         ]      = 0x2104,   /* Interrupt Mask Register - TODO: Needs verification */
    [REG_SIMR        ]      = 0x2114,   /* Socket Interrupt Mask Register (W6300 global IMR) */
    [REG_RTR         ]      = 0x4200,   /* Retry Time-value Register (W6300 address) */
        [REG_RTR_DEFAULT]   = 0x07d0,   /* Default retry time (2000) */
    
    [REG_RMSR        ]      = 0x0000,   /* TODO: Need to verify W6300 memory configuration */
    [REG_TMSR        ]      = 0x0000,   /* TODO: Need to verify W6300 memory configuration */
    
    /* Socket Registers - TODO: Need to verify complete W6300 socket register map */
    [REG_S0_REGS     ]      = 0x0800,   /* TODO: Needs verification */
    [REG_S0_REGS_LEN ]      = 0x0100,   /* TODO: Needs verification */
    
    [REG_Sn_MR       ]      = 0x0000,   /* TODO: Needs verification */
        [REG_S0_MR_MACRAW]  = 0x07,     /* TODO: Needs verification */
        [REG_S0_MR_MF    ]  = 0x40,     /* TODO: Needs verification */
    
    [REG_Sn_CR       ]      = 0x0010,   /* TODO: Needs verification */
        [REG_S0_CR_OPEN  ]  = 0x01,     /* OPEN command */
        [REG_S0_CR_CLOSE ]  = 0x10,     /* CLOSE command */
        [REG_S0_CR_SEND  ]  = 0x20,     /* SEND command */
        [REG_S0_CR_RECV  ]  = 0x40,     /* RECV command */
    
    [REG_Sn_IR]             = 0x0020,   /* TODO: Needs verification */
    [REG_set_Sn_IR]         = 0x0028,   /* TODO: Needs verification */
        [REG_S0_IR_SENDOK]  = 0x10,     /* SEND_OK interrupt */
        [REG_S0_IR_RECV]  = 0x04,     /* RECV interrupt */
    
    [REG_Sn_SR]      = 0x0030,   /* TODO: Needs verification */
        [REG_S0_SR_MACRAW]  = 0x42,     /* MACRAW status */
    
    [REG_Sn_TX_FSR   ]      = 0x0204,   /* TODO: Needs verification */
    [REG_Sn_TX_RD    ]      = 0x0208,   /* TODO: Needs verification */
    [REG_Sn_TX_WR    ]      = 0x020c,   /* TODO: Needs verification */
    [REG_Sn_RX_RSR   ]      = 0x0224,   /* TODO: Needs verification */
    [REG_Sn_RX_RD    ]      = 0x0228,   /* TODO: Needs verification */
    
    /* Memory Map - TODO: Need to verify complete W6300 memory map */
    [REG_TX_MEM_START]      = 0x20000,  /* TODO: Needs verification */
    [REG_TX_MEM_SIZE ]      = 0x8000,   /* TODO: Needs verification - W6300 may be larger */
    [REG_RX_MEM_START]      = 0x30000,  /* TODO: Needs verification */
    [REG_RX_MEM_SIZE ]      = 0x8000,   /* TODO: Needs verification - W6300 may be larger */
    
    /* W6300 specific registers (assumed same as W6100) */
    [REG_Sn_RX_BSR   ]      = 0x0220,   /* TODO: Needs verification - Check if same as W6100 */
    [REG_Sn_TX_BSR   ]      = 0x0200,   /* TODO: Needs verification - Check if same as W6100 */
    [REG_PHYCFG      ]      = 0x2E00,   /* TODO: Needs verification - Check if same as W6100 */
    [REG_PHYSTATE    ]      = 0x2E00,   /* TODO: Needs verification - Check if same as W6100 */
    [REG_PHYCFG_AUTONEG]    = 0xC8,     /* TODO: Needs verification - Check if same as W6100 */
};